...
### Pip installatie
Pip is een handig programma binnen Python om PyPi pakketten mee te downloaden en verwijderen.

1.'sudo apt update.
2.'sudo apt install python3-pip'
3.'pip3 --version' // Als de installatie is gelukt krijg je output met je Pip versie erin.
